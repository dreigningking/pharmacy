...
class SettingsController extends Controller
{
    ...
    public function admin_manage(Request $request){
        ...
        $advice = User::create(['name'=> $request->name,'email'=> $request->email,'password'=> Hash::make($request->email),'role_id'=> $request->role_id,'admin'=> true,'require_password_change'=> true,'country_id'=> 1,'state_id'=> 1,'city_id'=> 1]);
