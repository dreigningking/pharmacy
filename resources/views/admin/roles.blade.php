        ...
        <div class="col-md-12">
            ...
            <div class="profile-menu">
                <ul class="nav nav-tabs nav-tabs-solid">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#password_tab">Manager</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#per_details_tab">Pharmacist</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#password_tab">Sales Rep</a>
                    </li>
