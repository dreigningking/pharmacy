                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="invoice-info invoice-info2">
                                                            <a href="#" class="text-info"><u>Add new</u></a>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="table-responsive">
                                                            <table class="invoice-table table table-bordered">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="d-flex justify-content-between"><span>Description</span> <a href="#" class="font-weight-normal text-info"><u>Add New Item</u></a></th>
