                                                        ...
                                                        <div class="invoice-info invoice-info2">
                                                            ...
                                                            <div class="invoice-details no_select_border">
                                                                <select name="supplier_id" id="supplier_select"
                                                                    ...
                                                                    @empty
                                                                    <option disabled>No Other Pharmacy</option>
                                                                    @endforelse
                                                                        ...
                                                                        @forelse($inventories as $inventory)
                                                                            <tr>
                                                                                <td class="first-column">
                                                                                    <select name="inventory_id[]" class="select-remote form-control w-100">
                                                                                        <option id="{{$inventory->id}}">{{$inventory->name}}</option>
                                                                                    </select>
                                                                                </td>
                                                                                <td class="text-center select-row pl-0 pr-0 extra-column">
                                                                                    <input type="number" name="unit_cost" value="{{$inventory->unit_cost}}" id="" class="table-input">
                                                                                </td>
                                                                                <td class="text-center pl-0 pr-0 extra-column"> 
                                                                                    <input type="number" name="quantity" value="1" id="" class="table-input">
                                                                                </td>
                                                                                <td class="text-right">
                                                                                    {{$pharmacy->country->currency_symbol}}<span class="amount">100</span>
                                                                                </td>
                                                                                <td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Select Pharmacy
                </h5>
