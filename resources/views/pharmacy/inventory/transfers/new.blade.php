    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-8 col-xl-9">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('pharmacy.inventory.transfers.store',$pharmacy)}}" method="POST">@csrf
                                ...
                                <div class="other-info">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="col-md-12 text-right">
                                            ...
                                            <button type="submit" name="action" value="execute" class="btn btn-dark btn-sm supplies_submit disabled" disabled>Add to Inventory</button>
                                        </div>
