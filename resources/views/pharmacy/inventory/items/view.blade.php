                ...
                <div class="card widget-profile pat-widget-profile mb-0">
                    <div class="card-body">
                            ...
                            <div class="profile-info-widget">
                                ...
                                <div class="profile-det-info">
                                    ...
                                    <div class="patient-details">
                                        <h5><b>Item ID :</b> {{$item->id}}</h5>
                                        <h5 class="mb-0"><i class="fas fa-cog"></i>@if($item->drug_id) Drug @else Non Drug @endif</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="patient-info">
                            <ul>
                                <li>Stock <span>{{$item->available}}</span></li>
                                <li>Shelf <span>{{$item->shelf}}</span></li>
                                <li>Total Sold: <span>{{$item->saleDetails->sum('amount')}}</span></li>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table datatable table-hover table-center mb-0">
                                                ...
                                                <tbody>
                                                    @forelse ($item->saleDetails as $detail)
                                                    <tr>
                                                        <td>
                                                            
                                                                <h2 class="table-avatar">
                                                                    @if($detail->sale->user->image)
                                                                    <a href="#" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="{{asset('storage/user/photo/'.$detail->sale->user->image)}}" alt="User Image">
                                                                    </a>
                                                                    @endif 
                                                                    <a href="#">{{$detail->sale->user->name}}</a>
                                                                </h2>
                                                            
                                                        </td>
                                                        <td>{{$detail->created_at->format('d M Y')}} <span class="d-block text-info">{{$detail->created_at->format('h:i A')}}</span></td>
                                                        <td>{{$detail->batch}}</td>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="6" class="text-center"> No Sales</td>
                                                        </tr>
                                                    @endforelse
