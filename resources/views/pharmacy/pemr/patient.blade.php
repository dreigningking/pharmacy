                                                    ...
                                                    <div class="col-md-5">
                                                        <select class="form-control vitalquestions" name="vitals[assessments][]">
                                                            ...
                                                            @foreach ($vitals as $vital)
                                                                <option>{{$vital->type}} ({{$vital->unit}})</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-12 mt-3" id="past_medications">
                                                        <div class="row past_medication mb-1">
                                                            ...
                                                            <div class="col-md-2 pr-0">
                                                                ...
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="abcs" name="past_history[effectiveness][][]" value="0" class="custom-control-input">
                                        ...
                                        <div class="card-body">
                                            <div id="family_and_social_history">
                                                <div class="row familyhistoryrows mb-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="familyquestions[comments][]" placeholder="Comment">                                                       
                                                    </div>
                                                    <div class="col-md-2">
                                        ...
                                        <div class="card-body">
                                            <div id="system_review">
                                                <div class="row systemreviewrows mb-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" placeholder="Comments" name="vitals[answers][]">
                                                    </div>
                                                    <div class="col-md-2">
