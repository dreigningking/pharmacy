            ...
            <div class="col-md-7 col-lg-8 col-xl-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6>Top-10 High Volume Products Sold</h6>
                        <form action="">
                            <div class="row mt-5">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-5">
                                <table class="table table-striped">
                                    <tr>
                                        <th>
                                            Top-10 High Volume Products Sold
                                        </th>
                                        <th>
                                            Quantity Sold
                                        </th>
...
<script>
    ...
    if(results){
        ...
        const yVolume = results.map(b => b.quantity);
        console.log(xVolume)
